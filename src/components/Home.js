...
const Home = () => {
  return (
    <div className="flex flex-col md:flex-row justify-center items-center pt-[5rem] pb-[8rem] bg-gradient-to-r from-lime-100  to-cyan-100 ">
      <div className="w-[22rem] md:mr-6 rounded-full ">
        <img
